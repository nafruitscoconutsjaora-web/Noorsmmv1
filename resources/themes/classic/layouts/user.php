...
<body class="min-h-full flex bg-slate-950 text-slate-100">
    ...
    <aside class="w-64 bg-slate-900 border-r border-slate-800 flex flex-col fixed inset-y-0 z-30 hidden md:flex">
        ...
        <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto text-sm font-medium text-slate-300">
            ...
            <a href="/services/favorites" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 hover:text-white transition group">
                <span class="text-amber-400">★</span>
                Favorite Services
            </a>
            <a href="/services/compare" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 hover:text-white transition group">
                <span class="text-indigo-400">⚖️</span>
                Compare Services
            </a>
            <a href="/orders/analytics" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 hover:text-white transition group">
                <svg class="w-5 h-5 text-slate-400 group-hover:text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                Order Analytics
            </a>
            <a href="/orders/schedules" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 hover:text-white transition group">
                <span class="text-cyan-400">⏰</span>
                Scheduled Orders
            </a>
            <a href="/orders/refills" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 hover:text-white transition group">
            ...
            <a href="/wallet/activity" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 hover:text-white transition group">
                <span class="text-indigo-400">📜</span>
                Wallet Transactions
            </a>
            <a href="/referrals" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 hover:text-white transition group">
                <span class="text-amber-400">🎁</span>
                Affiliate & Referrals
            </a>
            <a href="/rewards" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 hover:text-white transition group">
            ...
            <a href="/help" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 hover:text-white transition group">
                <span class="text-slate-400">💡</span>
                Help & Guides
            </a>
            <a href="/account/api" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 hover:text-white transition group">
